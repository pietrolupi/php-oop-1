...
$productions = [
  ...
  new Movie('Fight Club', 'A depressed man suffering from insomnia meets a strange soap salesman named Tyler Durden and soon finds himself living in his squalid house after his perfect apartment is destroyed. The two bored men form an underground club with strict rules and fight other men who are fed up with their mundane lives.',['Satirical Novel', 'Thriller'], new Media('img/Fight_Club.webp', 'Fight Club'),1999,139),

  new Anime('Berserk', 'Berserk is a story that follows the story of Guts; a swordsman whose very existence has been Hell since he was born. Guts ends up suffering through a lot of traumatic events but ends up finding two opportunities to rise above his trauma.', ['Dark Fantasy', 'Seinen', 'Drama'], new Media('img/berserk.jpg', 'Berserk'),  'Netflix',18),
  ...
  new Anime('Jujutsu Kaisen', 'The story follows high school student Yuji Itadori as he joins a secret organization of Jujutsu Sorcerers to eliminate a powerful Curse named Ryomen Sukuna, of whom Yuji becomes the host.', ['Action', 'Horror', 'Modern'], new Media('img/jjk.jpg', 'jjk'),  'CrunchyRoll',16),
  ...
  new TvSerie('The Office', 'The Office is an American mockumentary sitcom television series that depicts the everyday work lives of office employees at the Scranton, Pennsylvania, branch of the fictional Dunder Mifflin Paper Company.', ['parody', 'comedy'], new Media('img/theoffice.jpg', 'theoffice'), 2005, 2013, 102, 9),

  new Anime('Attack on Titan', 'In the year 819, an Eldian spy in the Marley Public Security Authorities named Eren Kruger inherited the Attack Titan from an unknown predecessor.[20] During the thirteen years he held the Attack Titan, it is unknown how often he used it, if at all, until the year 832 when he brought Grisha Yeager to Paradis Island.', ['Adventure', 'Political Drama'], new Media('img/aot.jpg', 'jjk'),  'PrimeVideo',18),
  ...
  new Anime('DeathNote', 'The story follows Light Yagami, a genius high school student who discovers a mysterious notebook: the "Death Note", which belonged to the shinigami Ryuk, and grants the user the supernatural ability to kill anyone whose name is written in its pages.', ['Thriller', 'Investigative'], new Media('img/DeathNote.webp', 'deathnote'),  'PrimeVideo',16),
];