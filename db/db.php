...
$movies = [
  new Movie('Rambo', 'mah mah mah non so la lakalalalalla',['action','war'], new Media('img/rambo.jfif', 'Rambo')),
  
  new Movie('Fight Club', ' non so la lakalalkekekekekkekealalla',['drama','thriller', 'pulp'], new Media('img/fightclub.webp', 'Fight Club')),
